...
Read `{{SKILLS_PREFIX}}/tacos-audit/references/execute-runbook.md` for executor hardening. Follow audit-plan **## Work**, STOP conditions, and verify commands from the plan.
