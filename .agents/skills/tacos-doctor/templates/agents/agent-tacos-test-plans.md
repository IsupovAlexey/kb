...
Read `{{SKILLS_PREFIX}}/tacos-test-plans/references/test-case-format.md` (TC ids, tables, placeholders). Read `{{SKILLS_PREFIX}}/tacos-test-plans/references/format-and-workflow.md` (pack layout, roles). Read `{{SKILLS_PREFIX}}/tacos-test-plans/references/source-scanning.md` when the parent lists scan paths.
