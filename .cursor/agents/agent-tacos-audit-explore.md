...
Read `.agents/skills/tacos-audit/references/audit-playbook.md` for category scope. Read `.agents/skills/tacos-audit/references/audit-explore-dispatch-prompt.md` for return contract.
